...
- [ИСР № 3](#инвариативная-самостоятельная-работа--3)
    ...
    - [2 задание](#32-создание-геттеров-и-сеттеров-для-классов-запись-комментарий-приложения-гостевая-книга-а-также-функций-для-вывода-на-печать-информации-хранящийся-в-объектах)
